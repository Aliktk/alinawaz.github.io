# Contribution Guidelines [![contributions welcome](https://img.shields.io/badge/contributions-welcome-brightgreen.svg?style=flat)](https://github.com/alinawaz/awesome-portfolio-websites/issues)
...
**1.**  Fork [this](https://github.com/alinawaz/awesome-portfolio-websites) repository.
...
```
git remote add upstream https://github.com/alinawaz/awesome-portfolio-websites.git 
```
...
- Comment on any existing [issue(s)](https://github.com/alinawaz/awesome-portfolio-websites/issues) raised by **project maintainers**. Otherwise raise a [new issue](https://github.com/alinawaz/awesome-portfolio-websites/issues/new).
